...
printf "\nWRITE Settlement Manager v6.5.8 — Cloudflare Pages 自动更新\n"
printf "========================================================\n\n"
...
echo "正在上传 V6.5.8 到 Cloudflare Pages..."
"${WRANGLER[@]}" pages deploy "$DEPLOY_DIR" --project-name "$PROJECT" --branch main --commit-message "WRITE Settlement Manager v6.5.8" | tee "$LOG"
rm -rf "$DEPLOY_DIR"

echo "\n✅ Cloudflare V6.5.8 更新完成"
