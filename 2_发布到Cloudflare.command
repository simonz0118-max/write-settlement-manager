...
printf "\nWRITE Settlement Manager v6.5.5 — Cloudflare Pages 自动更新\n"
printf "========================================================\n\n"
...
echo "正在上传 V6.5.5 到 Cloudflare Pages..."
"${WRANGLER[@]}" pages deploy "$DEPLOY_DIR" --project-name "$PROJECT" --branch main --commit-message "WRITE Settlement Manager v6.5.5" | tee "$LOG"
rm -rf "$DEPLOY_DIR"

echo "\n✅ Cloudflare V6.5.5 更新完成"
