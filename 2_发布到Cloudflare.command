...
printf "\nWRITE Settlement Manager v5.3.0.2.2 — Cloudflare Pages 自动更新\n"
printf "========================================================\n\n"
...
"${WRANGLER[@]}" pages deploy "$DEPLOY_DIR" --project-name "$PROJECT" --branch main --commit-message "WRITE Settlement Manager v5.3.0.2.2" | tee "$LOG"
rm -rf "$DEPLOY_DIR"
