...
async function artifactsForWorkbook(workbookName){
 ...
 const audit={...x.audit,source:workbookName,generatedAt:new Date().toISOString(),invoiceCount:1,grouping:'country + complete package composition',originsMerged:true,pricing:'blank-red-human-entry',rows:x.rows};
