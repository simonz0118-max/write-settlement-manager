...
function repair(){
  ...
  document.querySelectorAll('.brand-copy small').forEach(x=>x.textContent='v11.1.0 Production');
  const f=document.querySelector('.v10612-side-footer span:last-of-type');if(f)f.textContent='v11.1.0';
}
function boot(){
  repair();let q=false;
