...
function apply(){document.body.classList.add('write-v1106');document.querySelectorAll('.brand-copy small').forEach(x=>{if(x.textContent!=='v11.0.6 Production')x.textContent='v11.0.6 Production'});const f=document.querySelector('.v10612-side-footer span:last-of-type');if(f&&f.textContent!=='v11.0.6')f.textContent='v11.0.6'}
