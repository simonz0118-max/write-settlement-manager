...
function apply(){
 ...
 document.querySelectorAll('.brand-copy small').forEach(x=>x.textContent='v11.0.5 Production');
 const f=document.querySelector('.v10612-side-footer span:last-of-type');if(f)f.textContent='v11.0.5';
}
